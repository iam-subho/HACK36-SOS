...
public class CustomAdapterWhatsapp extends ArrayAdapter<ContactModel> {

    Context context;
    List<ContactModel> contacts;
    public CustomAdapterWhatsapp(@NonNull Context context, List<ContactModel> contacts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_user_wa, parent, false);
        }
